...
L_Broker["Suffix - Max Rare"] = "稀有收集已满"
L_Broker["Suffix - Rare"] = "稀有"
...
if L_Capture then
-- 宠物捕捉相关
L_Capture["Rare pet upgrade found"] = "发现可升级的稀有宠物"
L_Capture["Rare pet upgrades found"] = "发现多个可升级的稀有宠物"
...
L_Config["Broker Goal - Collect at least one rare"] = "至少一只稀有"
L_Config["Broker Goal - Collect maximum amount"] = "收集最大数量"
L_Config["Broker Goal - Collect maximum amount rare"] = "收集稀有最大数量"
...
L_Config["Description - Rare Upgrade"] = "稀有品质升级"
...
L_Config["Forfeit Prompt Unless - Not maximum rare collected"] = "稀有收集未满"
L_Config["Forfeit Prompt Unless - Not rare"] = "非稀有"
L_Config["Forfeit threshold"] = "投降起始品质"
L_Config["Forfeit Threshold - Common"] = "普通"
L_Config["Forfeit Threshold - Poor"] = "弱小"
L_Config["Forfeit Threshold - Rare"] = "稀有"
...
L_Config["Map Pin Filter - Not maximum rare collected"] = "稀有收集未满的宠物"
L_Config["Map Pin Filter - Not rare"] = "非稀有品质的宠物"
...
L_Config["Notify if a Rare upgrade is found to an existing pet"] = "发现已有宠物可升级为稀有品质时发送通知"
L_Config["Notify on Rare upgrade"] = "稀有品质升级通知"
