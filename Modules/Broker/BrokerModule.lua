...
function BrokerModule:MetGoal(goal, numCollected, numRareCollected, limit)
    if WOW_PROJECT_ID == WOW_PROJECT_MAINLINE then if issecretvalue(goal) or issecretvalue(numCollected) or issecretvalue(numRareCollected) or issecretvalue(limit) then return end end -- #135 & taint fix
